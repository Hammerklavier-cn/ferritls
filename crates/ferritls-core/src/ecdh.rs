...
//!
//! **显式省略**：X448（RFC 7748）与 P-521——未进入原始里程碑范围
//! （M3 只定义了 X25519/P-256/384），基础设施已参数化（`fp_field!`/
//! `sw_curve!` 宏加实例即可），但域算术需新增 Fp448/Fp521 类型与
//! 向量集；候选余项，出口条件见 docs/ROADMAP.md「M8 发布后方向」。
//!
//! 安全设计：
